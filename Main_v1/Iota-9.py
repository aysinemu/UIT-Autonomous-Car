...
img = cv2.imread('/workspace/TurnRight/img_84.jpg', cv2.IMREAD_COLOR) 
# img = cv2.imread('/workspace/TurnLeft/img_47.jpg', cv2.IMREAD_COLOR) 
# img = cv2.imread('/workspace/Black.png', cv2.IMREAD_COLOR) 
# img = cv2.imread('/workspace/NoTurnRight/img_78.jpg', cv2.IMREAD_COLOR) 
# img = cv2.imread('/workspace/NoTurnLeft/img_35.jpg', cv2.IMREAD_COLOR) 
