            ...
            if mode == 0:
                if frameleft > (frameredright+frameredleft+frameright+framestop):
                    ...
                    if abs(deviation) >= devi:
                        print("Stop Done")
                        framestop = 0
                elif frameredleft > (frameredright+frameleft+frameright+framestop) and forward == 1:
                    AVControl( speed=30 , angle = -turn )
                    print("Turn Left Now")
                    if abs(deviation) >= devi:
                        print("Turn Left Done")
                        frameredleft = 0
                        forward = 0
                elif frameredright > (frameright+frameredleft+frameright+framestop) and forward == 1:
                    AVControl( speed=30 , angle = turn )
                    print("Turn Right Now")
                    if abs(deviation) >= devi:
                        print("Turn Right Done")
