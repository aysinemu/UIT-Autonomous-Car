...
if __name__ == "__main__":
    try:
        while True:
            ...
            if detect_circle_bool == 1:
                ...
                if detect_blue_sign_bool == 1:
                    ...
                    if detect_red_sign_bool == 1:
                        ...
                        # print("Sign Red")
                        # print("Arrow Red")
                        if angle_sign <= -40 and -50 >= angle_sign and distance_to_sign >= 120:
                            print("Turning Left Mode")
                            mode = 4
                        elif -50 >= angle_sign and distance_to_sign >= 120:
                            print("Turning Right Mode")
                            mode = 5
                    # arrow_dir = arrow(circle)
                    # print("Sign Red")
            ...
            #         t = 0
            if mode == 2:
                AVControl( speed=6 , angle = -8 )
            if mode == 3:
                AVControl( speed=4  , angle = 8 )
            if mode == 4:
                AVControl( speed=6  , angle = -18 )
            if mode == 5:
                AVControl( speed=6  , angle = 8 )
